...
function App() {
  ...
  const [layers, setLayers] = useState<LayerConfig[]>([
    { color: '#000000', heightPercentage: 10, td: 1.2 },   // Preto
    { color: '#666666', heightPercentage: 33, td: 2.8 },  // Cinza escuro
    { color: '#CCCCCC', heightPercentage: 66, td: 4.0 },  // Cinza claro
    { color: '#FFFFFF', heightPercentage: 100, td: 8.0 }  // Branco
  ]);
